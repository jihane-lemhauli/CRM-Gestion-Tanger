...
if conn:
    try:
        # Récupérer les noms des clients pour le filtre
...
# HADA HOWA L-BEDIL : rj3na "Filtrer par Client" f blast Shipment
...
# 8️⃣ BOUTONS D'ACTION (B7AL L-IMAGE)
c1, c2 = st.columns(2)
with c1:
    st.button("💾 Sauvegarder direct f Excel", use_container_width=True)
with c2:
